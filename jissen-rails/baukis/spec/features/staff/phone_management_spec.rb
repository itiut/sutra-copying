...
feature '職員による顧客電話番号管理' do
  ...
  scenario '職員が顧客の電話番号を追加する' do
    ...
    expect(customer.personal_phones[0].primary).to be true
  end
  ...
  scenario '職員が顧客の自宅電話番号を追加する' do
    ...
    expect(customer.home_address.phones[0].primary).to be true
  end
  ...
  scenario '職員が顧客の勤務先電話番号を追加する' do
    ...
    expect(customer.work_address.phones[0].primary).to be true
  end
end
